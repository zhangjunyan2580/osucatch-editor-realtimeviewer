...
namespace osu.Game.Rulesets.Difficulty.Skills
{
    ...
    /// </summary>
    public abstract class StrainSkill
    {
        ...
        /// </summary>
        protected abstract double StrainValueAt(PalpableCatchHitObject current);

        /// <summary>
        /// Process a <see cref="DifficultyHitObject"/> and update current strain values accordingly.
        /// </summary>
        public void Process(PalpableCatchHitObject current)
        {
            ...
            current.DifficultyToLast = strain * difficulty_multiplier;
        ...
        private void startNewSectionFrom(double time, PalpableCatchHitObject current)
        {
        ...
        protected abstract double CalculateInitialStrain(double time, PalpableCatchHitObject current);
