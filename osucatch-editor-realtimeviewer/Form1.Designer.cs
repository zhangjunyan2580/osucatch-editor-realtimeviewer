namespace osucatch_editor_realtimeviewer
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            hitobjectLabelToolStripMenuItem.DropDownItems.AddRange(new ToolStripItem[] { hideToolStripMenuItem, sameWithEditorToolStripMenuItem, noSliderVelocityMultiplierToolStripMenuItem, compareWithWalkSpeedToolStripMenuItem, difficultyStarsToolStripMenuItem });
