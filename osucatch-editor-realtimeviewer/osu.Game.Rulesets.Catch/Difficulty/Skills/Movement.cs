...
namespace osu.Game.Rulesets.Catch.Difficulty.Skills
{
    public class Movement : StrainDecaySkill
    {
        ...
        public Movement(float halfCatcherWidth, double clockRate)
            : base()
        {
        ...
        protected override double StrainValueOf(PalpableCatchHitObject catchCurrent)
        {
            ...
            if (catchCurrent.lastObject != null && catchCurrent.lastObject.DistanceToHyperDash <= 20.0f)
            {
