...
namespace osucatch_editor_realtimeviewer
{
    ...
    //    and gives (small, but could be large) errors.

    // Floating point errors are small but in osu!catch we can't accept it.
    // osu! rounds value to float, to double, to int everywhere and small errors can eventually grow large.
    ...
    // Option 3 is universal, only need to build the library once, but can create performace issues.
